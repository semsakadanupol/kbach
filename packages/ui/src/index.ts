...
// Both `import { clsx } from '@kbach/ui'` and `import clsx from '@kbach/ui'`
// work — the second matches how the real `clsx` package is conventionally
// imported, so switching to/from it (or porting code that already uses it)
// needs no import-statement changes, just the package name.
export default clsx;
