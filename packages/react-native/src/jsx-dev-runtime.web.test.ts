...
// reason jsx-dev-runtime.test.ts's identical mock exists for. Appearance
// is also needed — jsxRuntimeCore.ts imports darkModeStore.ts (see
// jsx-runtime.test.ts's own comment on this).
